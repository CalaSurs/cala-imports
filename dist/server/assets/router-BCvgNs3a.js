...
const appCss = "/assets/styles-Cv4Y0nTG.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Cala Imports — Premium Tech" },
      { name: "description", content: "Tecnología premium al mejor precio. Envíos a todo Argentina." },
...
const $$splitComponentImporter$1 = () => import("./catalog-CRy751vV.js");
const Route$1 = createFileRoute("/catalog")({
  head: () => ({
    meta: [{
      title: "Catálogo — Cala Imports"
    }, {
      name: "description",
      content: "Explorá todos los productos premium de Cala Imports: AirPods, JBL, fundas Apple y más."
    }, {
      property: "og:title",
      content: "Catálogo — Cala Imports"
    }, {
      property: "og:description",
      content: "Tecnología premium al mejor precio. Envíos a todo Argentina."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Bwf0pbWH.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Audio, accesorios y dispositivos premium. AirPods, JBL, fundas Apple y más. Envíos a todo el país, asesoramiento real por WhatsApp."
    }, {
      property: "og:title",
      content: "Cala Imports — Tecnología premium"
    }, {
      property: "og:description",
      content: "Tecnología premium al mejor precio. Envíos a todo Argentina."
    }]
...
const CatalogRoute = Route$1.update({
  id: "/catalog",
  path: "/catalog",
